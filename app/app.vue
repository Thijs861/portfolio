...
<template>
  <main class="max-w-5xl mx-auto px-4 py-12">
    <header class="flex justify-center items-center py-4 bg-[#1e1e1e]">
      <nav class="flex items-center space-x-8 bg-[#2a2a2a] border border-[#333] rounded-full px-10 py-3 text-gray-300 shadow-lg backdrop-blur-sm roboto">
